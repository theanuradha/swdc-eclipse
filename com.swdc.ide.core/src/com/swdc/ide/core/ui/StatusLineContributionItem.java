...
import com.swdc.ide.core.SWCoreImages;
...
public class StatusLineContributionItem extends ContributionItem {
    ...
    public StatusLineContributionItem(String id) {
        this(id, CALC_TRUE_WIDTH, false, null);
    }
    
    public StatusLineContributionItem(String id, boolean addTrailingSeparator) {
        this(id, CALC_TRUE_WIDTH, addTrailingSeparator, null);
    }

    public StatusLineContributionItem(String id,  String iconName) {
        this(id, CALC_TRUE_WIDTH, false, iconName);
    }
    ...
    public StatusLineContributionItem(String id, int charWidth) {
        this(id, charWidth, false, null);
    }

    public StatusLineContributionItem(String id, int charWidth, boolean addTrailingSeparator, String iconName) {
        super(id);
        ...
        if (label != null && !label.isDisposed()) {
            ...
            if (errorText != null && errorText.length() > 0) {
                ...
                if (iconName != null) {
	                ...
	                try {
	                		image = SWCoreImages.getImage(imgDescriptor);
