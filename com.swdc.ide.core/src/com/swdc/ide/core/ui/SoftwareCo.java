...
import com.swdc.ide.core.ui.SoftwareCoKeystrokeManager.KeystrokeCountWrapper;


public class SoftwareCo {

	public static final String VERSION = Platform.getBundle( SWCorePlugin.ID ).getVersion().toString();
	...
	public void earlyStartup() {
		...
		workbench.getDisplay().asyncExec(new Runnable() {
			public void run() {
				...
				SWCoreLog.logInfoMessage("Software.com: Loaded v" + VERSION + " on platform: " + SWT.getPlatform());
	...
	public static void handleFileOpenedEvent() {
		...
		SWCoreLog.logInfoMessage("Software.com: file opened: " + fileName);
	}
	...
	public static void handleFileClosedEvent(String fileName) {
		...
		SWCoreLog.logInfoMessage("Software.com: file closed: " + fileName);
	}
	...
	protected static int getLineCount(String fileName) {
        ...
        try {
        	...
        	SWCoreLog.logInfoMessage("Software.com: failed to get the line count for file " + fileName);
            return 0;
        }
    }
	...
	public static void handleChangeEvents(DocumentEvent docEvent) {
		...
		if (!isNewLine) {
	        ...
	        if (numKeystrokes > 1) {
		        ...
		        SWCoreLog.logInfoMessage("Software.com: Copy+Paste incremented");
		        ...
		        SWCoreLog.logInfoMessage("Software.com: Delete incremented");
	        } else if (numKeystrokes == 1) {
	        	// increment the specific file keystroke value
		        updateFileInfoValue(fileInfo, "add", 1);
		        SWCoreLog.logInfoMessage("Software.com: KPM incremented");
	        }
		}
        ...
        if (isNewLine) {
            ...
            SWCoreLog.logInfoMessage("Software.com: lines added incremented");
        }
	...
	private static IEditorInput getWorkbenchIEditorInput() {
		...
		try {
			...
			SWCoreLog.logInfoMessage("Software.com: Unable to retrieve the IEditorInput from workbench window. " + e.getMessage());
			return null;
		}
	}
